...
function AppInner({ selection, setSelection, viewerOpen, viewerIndex, viewSubIds, openViewer, closeViewer, saveStatus }) {
  const isMobile = useIsMobile()
  const navigate = useNavigate()
  const location = useLocation()

  // Map current path → tab id (strip trailing slash for root)
  ...
  return (
    <>
      ...
      {/* paddingTop accounts for nav bar + safe area (safe-top is already on body, nav sits below it) */}
